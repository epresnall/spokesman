...
const testimonials = [
  ...
  { name: "Konstantyn Shyshkin", photo: "/images/Konstantyn-Shyshkin---LI-Photo.jpeg", text: "Eric is top-notch talent! He's amazing and high-energy on screen, but extremely professional as well, and is a pleasure to work with. He also adheres to deadlines! We'll continue to work with Eric for much longer, because he's been so easy and fun to work with." },
  { name: "Kelly Cambry", photo: "/images/Kelly-Cambry---LI-Photo.jpeg", text: "Eric was a charm to work with. His on camera talent was spot on and he executed our project with flair. He is extremely detailed and thorough. Looking forward to working with him again soon and we've told all our clients looking for this type of project to call him. Excellent work!" },
  { name: "Pia Larson", photo: "/images/Pia-Larson---LI-Photo.jpeg", text: "Eric delivered everything we asked for and more in a timely and professional manner. He's been a pleasure to work with and will be an ongoing part of our team." },
  { name: "Kamar Brown", photo: "/images/Kamar-Brown---LI-Photo.jpeg", text: "Eric has been a great spokesman for all of our programs and records some of the highest converting videos that we advertise with!" },
];
